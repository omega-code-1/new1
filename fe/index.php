                    ...
                    <div class="collapse navbar-collapse" id="navbarSupportedContent">
                        <ul class="navbar-nav  mx-auto ">
                            <li class="nav-item active">
                                <a class="nav-link" href="/fe">Home <span class="sr-only">(current)</span></a>
                            </li>
                            <li class="nav-item">
                            ...
                            <li class="nav-item">
                                <a class="nav-link" href="/fe/reservasi">Book Table</a>
                            </li>
                        </ul>
                ...
                <div class="owl-carousel client_owl-carousel">
                    <div class="item">
                        <div class="box">
                            ...
                            <div class="img-box">
                                <img src="img/client1.jpg" alt="" class="box-img">
                            </div>
                        </div>
                    </div>
                    <div class="item">
                        <div class="box">
                            ...
                            <div class="img-box">
                                <img src="img/client2.jpg" alt="" class="box-img">
                            </div>
                        </div>
                    </div>
                </div>
